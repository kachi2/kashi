            ...
            <div class="col-12 col-md-6">
              <div class="card weekly-product-card mb-3">
                <div class="card-body d-flex align-items-center">
                  <div class="product-thumbnail-side"><a class="product-thumbnail d-block" href="{{route('product-details', $pro->id)}}">
                  ...
                  <div class="product-description"><a class="product-title d-block" href="">{{$pro->name}}</a>
                    ...
                    <div class="product-rating"><i class="lni lni-star-filled"></i>{{$pro->views}} Views</div>
                    <a class="btn btn-primary btn-sm" href="{{route('my-productEdit',$pro->id)}}">Edit</a>
                    <a class="btn btn-danger btn-sm" onclick="return confirm('Are you sure')" href="{{route('my-productDelete', $pro->id)}}">Delete</a>
                  </div>
                </div>
              </div>
            </div>  
...
<div class="card weekly-product-card mb-3">
                <div class="card-body d-flex align-items-center">
          You currently do not have any product yet. 
  </div>
  </div>
         @endif
        </div>
