            ...
            <div class="register-form mt-5 px-4">
             ...
             <form method="POST" action="{{ route('referral-register') }}">
                        @csrf
                          ...
                          <div class="form-group text-left mb-4"><span>Referral Email</span>
                  <label for="username"><i class="lni lni-envelope"></i></label>
                 
                 {!!Form::text('referral', \Request::get('referral'), ['class' => 'form-control','placeholder' =>'Referral Email', 'id'=>'referral'])!!}  
                  @if(Session::has('referrals'))<span class="invalid-feedback" role="alert"> {{Session::get('referrals')}}</span>@endif
                </div>
