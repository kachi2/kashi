        ...
        <table class="table table-striped table-bordered" id="table2">
                                   ...
                                   @foreach ($category as $cats )
                                    ...
                                    <tr>
                                        ...
                                        @foreach ($cats->subcat as $key => $cat)
                                           <p><span style="color:blue">- </span>{{$cat->name}}</p>
                                        @endforeach
                                        </ul>
                                        </td>
                                        <td>{{$cats->created_at->format('d-m-yy')}}</td>
                                        <td>
                                        {{Form::open(['action'=> ['CategoryController@edit', $cats->id], 'method'=>'get'])}}
                                          <button class="btn btn-primary btn-xs">Edit</button>
                                          {{Form::close()}}
                                           {{Form::open(['action'=> ['CategoryController@destroy', $cats->id], 'method'=>'POST'])}}
